...
public class ReadQuestionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_read_question, container, false);
        ...
        for(Question question: questions){
            ...
            String userCorrectAnswer = question.getCorrectAnswer();
            info = info + "\n\nid: " + id + "\nQuestion: " + userQuestion + "\n" + "Answer1: " + userAnswer1 + "\n Answer2: " + userAnswer2 + "\n Correct Answer: " + userCorrectAnswer;
        }
